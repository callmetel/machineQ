jQuery(document).ready(function($) {
    ...
    var ease1 = Sine.easeOut, ease2 = Sine.easeInOut, speed = .85, sections = $("#section-1, #section-2, #section-3, #section-4, #section-5, #section-6, #section-7"), internalPages = $("#main .container").detach(), eventsPage = $("#news-events .container").detach();
    $("#main").append(internalPages);
    TweenMax.set([ "#section-2, #section-3, #section-4, #section-5, #section-6, #section-7, #section-8" ], {
        y: "100%",
        alpha: 0
    });
    TweenMax.set("#comcast-logo", {
        alpha: 0
    });
    TweenMax.set(".bg", {
        alpha: .5
    ...
    function toggleEvents() {
        if ($("#news-events").hasClass("event-is-inactive")) {} else if (!$("#news-events").hasClass("event-is-inactive")) {
            $("#main").append(internalPages);
            TweenMax.to("#events", speed, {
                x: "120%",
                ease: ease1
            });
    ...
    function checkSlideUp() {
        if ($("#section-1").hasClass("is-current-section")) {
            ...
            TweenMax.to("#section-2", speed, {
                y: "100%",
                alpha: 0,
                ease: ease1
            });
            TweenMax.to("#section-1", speed, {
                y: "0%",
                alpha: 1,
                ease: ease2,
                delay: .1
            });
            TweenMax.to("#comcast-logo", .5, {
                alpha: 0
            });
            TweenMax.to("#comcast-copyright", .5, {
                alpha: 1,
                delay: 1.2
            });
            TweenMax.to(".bg", .5, {
            ...
            TweenMax.set("#case-icon-container", {
                y: "0%"
            });
            TweenMax.set(".platform-icon", {
                alpha: 1,
                y: "0%"
            });
            TweenMax.set("#section-5 .cta", {
                alpha: 1
            });
            TweenMax.set(".molecule-text", {
                alpha: 0
            });
            TweenMax.set(".icon-trigger:not(.is-disabled)", {
                zIndex: 100
            });
            $(".platform-icon").removeClass("scaleActive").addClass("scaleInactive");
            iconclicked = 0;
            TweenMax.to("#section-5", speed, {
                y: "100%",
                alpha: 0,
                ease: ease1
            });
    ...
    if (isMobile.detectMobile() && !$("html").hasClass("iPhone-Plus")) {
        ...
        $("body").bind("touchmove", function(event) {
            ...
            if (touchReg == false && status === 0 && $("#menu").hasClass("nav-is-inactive") && !$("#news-events").hasClass("event-is-active")) {
        ...
        $("#down, #home-down").bind("touchend", function(e) {
            ...
            TweenMax.set("#section-1", {
                y: "-100%",
                alpha: 0
            });
            TweenMax.set([ "#section-3, #section-4, #section-5, #section-6, #section-7, #section-8" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#menu li:eq(2)").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-1, #section-2" ], {
                y: "-100%",
                alpha: 0
            });
            TweenMax.set([ "#section-4, #section-5, #section-6, #section-7, #section-8" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#menu li:eq(3)").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-1, #section-2, #section-3" ], {
                y: "-100%",
                alpha: 0
            });
            TweenMax.set([ "#section-5, #section-6, #section-7, #section-8" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#menu li:eq(4)").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-1, #section-2, #section-3, #section-4" ], {
                y: "-100%",
                alpha: 0
            });
            TweenMax.set([ "#section-6, #section-7, #section-8" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#menu li:eq(5)").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-1, #section-2, #section-3, #section-4, #section-5, #section-6" ], {
                y: "-100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#down, #home-down").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-3, #section-4, #section-5, #section-6, #section-7" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#case-down, #use-case-down").bind("touchend", function(e) {
            TweenMax.to("#section-6", speed, {
                y: "0%",
                alpha: 1,
                ease: ease2,
                delay: .1
            });
            TweenMax.set([ "#section-1, #section-2, #section-3, #section-4, #section-5" ], {
                y: "-100%",
                alpha: 0
            });
            TweenMax.set("#section-7", {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#section-2 .cta").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-4, #section-5, #section-6, #section-7" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#section-3 .cta").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-5, #section-6, #section-7" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#section-4 .cta").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-6, #section-7" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $("#section-7 .cta").bind("touchend", function(e) {
            ...
            TweenMax.set([ "#section-1, #section-2, #section-3, #section-4, #section-5, #section-6, #section-7" ], {
                y: "100%",
                alpha: 0
            });
            TweenMax.to("#comcast-logo", .5, {
        ...
        $(".icon-trigger:not(.is-disabled)").bind("touchend", function(e) {
            ...
            setTimeout(function() {
                TweenMax.to(".scaleInactive .molecule-text", speed, {
                    alpha: 0,
                    ease: ease1
                });
                TweenMax.set(trigger, {
            ...
            if (window.orientation !== 0) {
                ...
                if (icon.hasClass("scaleActive")) {
                    TweenMax.staggerTo(moleculeText2, speed, {
                        alpha: 0,
                        ease: ease1
                    }, -.15);
                    TweenMax.to(icon, speed, {
                        alpha: .15,
                        ease: ease1
                    });
                    icon.removeClass("scaleActive").addClass("scaleInactive");
                    TweenMax.to("#case-icon-container", 1, {
                        y: "68%"
                    });
                    setTimeout(function() {
                        if (!$(".platform-icon").hasClass("scaleActive")) {
                            TweenMax.to("#case-icon-container", speed, {
                                y: "0%"
                            });
                            TweenMax.to(allIcons, speed, {
                                alpha: 1,
                                ease: ease1
                            });
                            TweenMax.to("#section-5 .cta", speed, {
                                alpha: 1
                            });
                        }
                    }, 850);
                } else {
                    TweenMax.staggerTo(moleculeText, speed, {
                        alpha: 0,
                        ease: ease1
                    }, -.15);
                    ...
                    TweenMax.to(platformIcon, speed, {
                        alpha: .15,
                        ease: ease1
                    });
                    TweenMax.set(".platform-icon:not(.scaleActive) .icon-trigger", {
                        zIndex: -1e3
                    });
                    setTimeout(function() {
                        TweenMax.set(".platform-icon:not(.scaleActive) .icon-trigger", {
                ...
                if (iconclicked == 0) {
                    ...
                    TweenMax.to(".platform-icon:not(.scaleActive)", speed, {
                        alpha: .1,
                        ease: ease1
                    });
                    TweenMax.to(".platform-icon:not(.scaleActive) ,icon-trigger", speed, {
                        zIndex: -1e3
                    });
                    if ($(this).is($("div.icon-trigger:first"))) {
                        ...
                        TweenMax.to("#at-container", speed, {
                            y: "-15%"
                        });
                        TweenMax.to(ctaIOS, speed, {
                            bottom: "13vh"
                        });
                    }
                    iconclicked = 1;
        ...
        $(window).resize(function() {
            var bodyWidth = $(document).outerWidth(), bodyHeight = $(document).outerHeight(), bodyRatio = bodyWidth / bodyHeight, dblBodyHeight = bodyHeight * 2;
        ...
        function changeBoxGrid() {
            var bodyWidth = $(window).outerWidth(), bodyHeight = $(document).outerHeight();
