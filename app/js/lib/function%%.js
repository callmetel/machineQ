					...
					$('.mix').click(function(){
						...
						//Scrollmagic Starts HERE
						  ...
						  var scene = new ScrollMagic.Scene({
						    triggerElement: '#trigger1',
						    duration: '5.27%',
						    offset: '0.98%' /* offset the trigger 150px below #scene's top */
						  })
						  .setTween(tween);
						...
						var tween1a = TweenMax.fromTo('.mainline1a', 1.5, {drawSVG:"100% 100%"}, {drawSVG:"0% 100%"} );
						 ...
						 var scene1a = new ScrollMagic.Scene({
						    triggerElement: '#trigger1a',
						    duration: '9.88%',
						    offset: -'0.66%' /* offset the trigger 150px below #scene's top */
						  })
						  .setTween(tween1a);
						 ...
						 var scene1aa = new ScrollMagic.Scene({
						   triggerElement: '#target-1',
						   duration:'3.29%',
						   offset: '3.95%' /* offset the trigger 150px below #scene's top */
						 })
						 .setPin('.svg-container');
						 ...
						 var scene1b = new ScrollMagic.Scene({
						    triggerElement: '#target-1',
						    duration: '9.88%',
						    offset: '7.25%' /* offset the trigger 150px below #scene's top */
						  })
						  .setTween(tween1b);
						 ...
						 var scene2a = new ScrollMagic.Scene({
						    triggerElement: '#target-2',
						    duration: '3.95%',
						    offset: '3.29%' /* offset the trigger 150px below #scene's top */
						  })
						  .setTween(tween2a);
						...
						var scene3a = new ScrollMagic.Scene({
						   triggerElement: '#target-3',
						   duration: '4.61%',
						   offset: '1.98%' /* offset the trigger 150px below #scene's top */
						 })
						 .setTween(tween3a);
						...
						var tween3b = TweenMax.fromTo('.mainline3b', 1.5, {drawSVG:"0% 0%"}, {drawSVG:"0% 100%"} ); 
						 ...
						 var scene3b = new ScrollMagic.Scene({
						    triggerElement: '#target-3',
						    duration: '8.57%',
						    offset: '4.08%' /* offset the trigger 150px below #scene's top */
						  })
						  .setTween(tween3b);
						...
						var scene3c = new ScrollMagic.Scene({
						   triggerElement: '#target-4',
						   duration: '5.27%',
						   offset: -'6.59%' /* offset the trigger 150px below #scene's top */
						 })
						 .setTween(tween3c);
						...
						var scene4 = new ScrollMagic.Scene({
						 ...
						 var scene4aa = new ScrollMagic.Scene({
						   triggerElement: '#target-4',
						   duration: '3.29%',
						   offset: '5.27%' /* offset the trigger 150px below #scene's top */
						 })
						 .setPin('.text-4');
						...
						var scene4a = new ScrollMagic.Scene({
						   triggerElement: '#target-4',
						   duration: '4.61%',
						   offset: '2.63%' /* offset the trigger 150px below #scene's top */
						 })
						 .setTween(tween4a);
						...
						var scene6a = new ScrollMagic.Scene({
						   triggerElement: '#target-6',
						   duration: '7.25%',
						   offset: '9.23%' /* offset the trigger 150px below #scene's top */
						 })
						 .setTween(tween6a);
